...
import { BoxGeometry, Scene, Vector3 } from '../build/three.module.js';
...
export class Carro {
    ...
    this.criaParaChoque = function(){
        ...
        //quadrados da linha de cima

        paraChoqueF.push(new THREE.Vector3(-0.5,  -0.022, 0.47));
        paraChoqueF.push(new THREE.Vector3(0.5,   -0.022, 0.4501));
        paraChoqueF.push(new THREE.Vector3(-0.346,-0.022, 0.515));
        paraChoqueF.push(new THREE.Vector3(0.346, -0.022, 0.515));

        // descubra 0
        paraChoqueF.push(new THREE.Vector3(-0.5,  -0.194,0.47));
        paraChoqueF.push(new THREE.Vector3(0.5,   -0.194,0.47));
        paraChoqueF.push(new THREE.Vector3(-0.346,-0.194,0.515));
        paraChoqueF.push(new THREE.Vector3(0.346, -0.194,0.515));

         //quadrados da linha de baixo
        paraChoqueF.push(new THREE.Vector3(-0.466,-0.142,0.47));
        paraChoqueF.push(new THREE.Vector3(0.466, -0.142,0.47));
        paraChoqueF.push(new THREE.Vector3(-0.346,-0.142,0.485));
        paraChoqueF.push(new THREE.Vector3(0.346, -0.142,0.485));

        //descubra 1

        paraChoqueF.push(new THREE.Vector3(-0.346,-0.31, 0.47));
        paraChoqueF.push(new THREE.Vector3(0.346, -0.31, 0.47));
        paraChoqueF.push(new THREE.Vector3(-0.346,-0.194,0.47));
        paraChoqueF.push(new THREE.Vector3(0.346, -0.194,0.47));
        paraChoqueF.push(new THREE.Vector3(-0.346,-0.242,0.47));
        paraChoqueF.push(new THREE.Vector3(0.346, -0.242,0.47));
    ...
    this.criaVidroFrente = function(){
        ...
        this.updateConvexObject = function(){
            ...
            paraChoquef.translateX(3.38);
            paraChoquef.translateY(1.2);

            paraChoquef.rotateY(THREE.MathUtils.degToRad(90));
